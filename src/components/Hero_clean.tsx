          ...
          <div className="lg:w-1/2 text-center lg:text-left space-y-6 lg:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/get-involved">
                <Button size="lg" className="bg-gradient-to-r from-[#f78614] to-[#e85a2b] hover:from-[#e85a2b] hover:to-[#d64e1f] text-white px-10 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
                  🤝 Join Our Mission
                </Button>
              </Link>
              <Link href="/about">
                <Button variant="outline" size="lg" className="border-2 border-[#f78614] text-[#f78614] hover:bg-[#f78614] hover:text-white px-10 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-200">
                  📖 My Journey
                </Button>
              </Link>
            </div>
